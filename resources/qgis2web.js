var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         center: [6493018, 8046700], // Координаты центра Горнозаводска
         zoom: 14.6,                    // СЮДА ПИШИТЕ ЦИФРУ МАСШТАБА ПРИ ЗАГРУЗКЕ
         maxZoom: 19,                 // Предел приближения
         minZoom: 6                   // Предел отдаления
    })
});
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">слои веб-карты</h2>';
        return titleElement;
    })(),
